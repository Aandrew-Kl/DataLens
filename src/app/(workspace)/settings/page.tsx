    ...
    <div className="space-y-5">
              ...
              <button
                ...
                className={`rounded-2xl border px-4 py-2 text-sm ${
                  active
                    ...
                    : "border-white/40 bg-white text-slate-700 hover:border-cyan-300 dark:bg-slate-900 dark:text-slate-100"
                }`}
              >
      ...
      <section className={glass}>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="inline-flex items-center justify-between rounded-2xl border border-white/30 bg-white p-3 text-sm dark:border-white/10 dark:bg-slate-900">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className="rounded-2xl border border-white/40 px-4 py-2 text-sm font-semibold hover:bg-white dark:border-white/15 dark:hover:bg-slate-900/35"
        >
          Reset defaults
        </button>
        <p className="rounded-2xl border border-cyan-300/40 bg-cyan-50 px-4 py-2 text-sm text-cyan-700 dark:bg-slate-950 dark:text-cyan-300">
