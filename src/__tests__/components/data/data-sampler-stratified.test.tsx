...
import DataSamplerStratified from "@/components/data/data-sampler-stratified";
...
describe("DataSamplerStratified", () => {
  it("renders without crashing", async () => {
    await act(async () => {
      render(<DataSamplerStratified tableName="test_table" columns={columns} />);
    });
