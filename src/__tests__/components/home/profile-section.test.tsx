...
jest.mock("@/components/data/column-profiler-advanced", () =>
  mockComponent("Column Profiler Advanced"),
);
jest.mock("@/components/data/data-alerts", () => mockComponent("Data Alerts"));
jest.mock("@/components/data/data-overview", () =>
  mockComponent("Data Overview"),
);
jest.mock("@/components/data/data-profiler", () =>
  mockComponent("Data Profiler"),
);
jest.mock("@/components/data/data-profiler-ai", () =>
  mockComponent("Data Profiler AI"),
);
jest.mock("@/components/data/data-profiler-full", () =>
  mockComponent("Data Profiler Full"),
);
jest.mock("@/components/data/data-profiler-summary", () =>
  mockComponent("Data Profiler Summary"),
);
jest.mock("@/components/ui/data-tour", () => mockComponent("Data Tour"));
jest.mock("@/components/ui/empty-state", () => mockComponent("Empty State"));
jest.mock("@/components/ui/search-input", () => mockComponent("Search Input"));
jest.mock("@/components/home/DataTableSection", () =>
  mockComponent("Data Table Section"),
);
...
describe("ProfileSection", () => {
  ...
  it("renders the section heading", () => {
    ...
    expect(
      screen.getByRole("heading", { level: 2, name: "Column Profiles" }),
    ).toBeInTheDocument();
  });

  it("renders the data overview panel", () => {
    render(<ProfileSection {...defaultProps} />);
