        ...
        {open ? (
          ...
          >
            ...
            <motion.aside
              ...
              className={`absolute right-0 top-0 h-full w-full max-w-md p-4 shadow-sm ${GLASS_PANEL_CLASS}`}
            >
              <div className="flex h-full flex-col rounded-lg border border-white/20 bg-white p-5 dark:bg-slate-950/35">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button
                    ...
                    onClick={() => setOpen(false)}
                    className="rounded-2xl border border-white/20 bg-white p-2.5 text-slate-700 dark:bg-slate-950 dark:text-slate-200"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </div>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white px-4 py-2.5 text-sm font-semibold text-slate-800 transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-60 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-950"
                  >
