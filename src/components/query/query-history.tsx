      ...
      <div className="border-b border-gray-200/60 px-4 py-4 dark:border-gray-700/50">
        ...
        <div className="relative mt-4">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200/80 bg-white py-2.5 pl-10 pr-10 text-sm text-gray-700 outline-none transition focus:border-sky-300 focus:ring-2 focus:ring-sky-400/20 dark:border-gray-700/70 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-sky-500"
          />
          {search && (
            <button
              type="button"
                    ...
                    <AnimatePresence initial={false}>
                      {group.items.map((entry, index) => (
                        <motion.div
                          ...
                          className="group rounded-2xl border border-gray-200/70 bg-white p-4 text-left transition hover:border-sky-300/70 hover:shadow-sm dark:border-gray-700/60 dark:bg-gray-800 dark:hover:border-sky-700/70"
                        >
                          ...
                          <pre className="mt-3 overflow-hidden rounded-xl border border-gray-200/60 bg-gray-50 px-3 py-3 font-mono text-xs leading-5 text-gray-600 dark:border-gray-700/60 dark:bg-gray-900 dark:text-gray-300">
