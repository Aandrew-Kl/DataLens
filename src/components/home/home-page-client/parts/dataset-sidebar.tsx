...
export function DatasetSidebar({
  ...
  if (!isOpen) {
    return (
      <div className="flex w-14 shrink-0 flex-col items-center gap-3 border-r border-slate-200 bg-white py-4 dark:border-slate-700/50 dark:bg-gray-900">
        <button
          onClick={onToggle}
  ...
  return (
    <motion.div
      ...
      className="flex w-60 shrink-0 flex-col overflow-hidden border-r border-slate-200 bg-white dark:border-slate-700/50 dark:bg-gray-900"
    >
