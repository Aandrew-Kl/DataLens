              ...
              <button
                ...
                className={`rounded-2xl border px-4 py-3 text-sm font-medium transition ${
                  view === "ranked"
                    ...
                    : "border-white/15 bg-white text-slate-600 dark:bg-slate-950/35 dark:text-slate-200"
                }`}
              >
                Ranked pairs
              </button>
                      ...
                      <button
                        ...
                        className={`w-full rounded-3xl border p-4 text-left transition ${
                          active
                            ...
                            : "border-white/15 bg-white hover:border-cyan-300/30 dark:bg-slate-950/35"
                        }`}
                      >
                        <div className="flex flex-wrap items-start justify-between gap-3">
                          ...
                          <div className="rounded-full border border-white/15 bg-white px-3 py-1 text-xs font-semibold text-slate-700 dark:bg-slate-950 dark:text-slate-200">
