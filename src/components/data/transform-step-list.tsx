    ...
    <aside className="space-y-5">
      <div className="rounded-2xl border border-gray-200/60 bg-white p-4 dark:border-gray-700/60 dark:bg-gray-950/35">
        ...
        <div className="mt-4 space-y-2">
          {currentColumns.map((column) => (
            <div key={column.name} className="flex items-center justify-between gap-3 rounded-xl border border-gray-200/60 bg-white px-3 py-2 text-sm dark:border-gray-700/60 dark:bg-gray-950/35">
          ...
          {currentColumns.length === 0 && (
            <div className="rounded-xl border border-dashed border-gray-200/70 bg-white px-3 py-4 text-sm text-gray-500 dark:border-gray-700/70 dark:bg-gray-950/25 dark:text-gray-400">
      ...
      <div className="rounded-2xl border border-gray-200/60 bg-white p-4 dark:border-gray-700/60 dark:bg-gray-950/35">
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <span className="rounded-full border border-gray-200/70 bg-white px-3 py-1 text-xs font-semibold text-gray-600 dark:border-gray-700/70 dark:bg-gray-950 dark:text-gray-300">
        ...
        <div className="space-y-3">
          <AnimatePresence initial={false}>
            {history.map((entry) => (
              <motion.div key={entry.id} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="rounded-2xl border border-gray-200/60 bg-white p-3 dark:border-gray-700/60 dark:bg-gray-950/35">
                ...
                <div className="mt-3 grid gap-2 sm:grid-cols-2">
                  <div className="rounded-xl border border-gray-200/60 bg-white px-3 py-2 text-xs dark:border-gray-700/60 dark:bg-gray-950/25">
          ...
          {history.length === 0 && (
            <div className="rounded-2xl border border-dashed border-gray-200/70 bg-white px-4 py-8 text-center text-sm text-gray-500 dark:border-gray-700/70 dark:bg-gray-950/25 dark:text-gray-400">
